...
- [x] **T4.1.1** 创建图片上传插件 `imagePlugin.ts`
  - 拦截图片粘贴
  - 拦截图片拖拽
  - 处理图片上传
...
- [x] **T4.5.1** 创建搜索对话框 `SearchDialog.vue`
  - 快捷键 Cmd/Ctrl+F 打开
  - 浮动搜索栏

- [x] **T4.5.2** 实现搜索功能
  - 实时搜索高亮 (searchHighlightPlugin)
  - 匹配计数显示
  - 上/下一个匹配
  - 大小写敏感选项
  - 正则表达式选项
...
- [x] **T5.3.1** 实现专注模式 ✅
  - 隐藏侧边栏、工具栏、状态栏、标题栏
  - Cmd/Ctrl + Shift + Enter 切换
  - ESC 退出专注模式
  - 退出提示动画

- [x] **T5.3.2** 实现打字机模式 ✅
  - 当前行保持屏幕中央 (padding-top/bottom: 40vh)
  - 平滑滚动
  - Cmd/Ctrl + Shift + T 切换
...
- [x] **T5.4.1** 创建设置对话框 `SettingsDialog.vue` ✅
  - 分类标签页（Appearance、Editor、Files）
  - 设置项搜索
  - 重置默认
  - Cmd/Ctrl + , 快捷键打开
